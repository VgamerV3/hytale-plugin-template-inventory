...
public final class InventoryPluginState {
  private final AtomicReference<InventoryPluginLifecycle> lifecycle = new AtomicReference<>(InventoryPluginLifecycle.NEW);
  ...
  private volatile String templateName = "Inventory";
  private volatile String dataDirectory = "";

  public InventoryPluginLifecycle getLifecycle() {
    return lifecycle.get();
  }

  public void setLifecycle(InventoryPluginLifecycle next) {
    lifecycle.set(next);
  }
