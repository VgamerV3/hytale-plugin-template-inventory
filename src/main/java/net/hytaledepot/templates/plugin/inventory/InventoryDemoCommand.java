...
public final class InventoryDemoCommand extends AbstractCommand {
  ...
  public InventoryDemoCommand(InventoryPluginState state, InventoryDemoService demoService, AtomicLong heartbeatTicks) {
    super("hdinventorydemo", "Runs a demo action for the Inventory template.");
